...
lainStyBtn.addEventListener('mouseout', function(){
  ...
  themebutton.addEventListener("click", () =>{
    ...
    const nameTxtBx = document.querySelector('.nameTxtBx');
    const emailTxtBx = document.querySelector('.emailTxtBx');
    const messageTxtBx = document.querySelector('.messageTxtBx');
